...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="/img/kasira.png" />
...
<body>
      ...
      <div class="scroll-sidebar" data-simplebar>
        <div class="d-flex mb-4 align-items-center justify-content-between">
            <a href="index.html" class="text-nowrap logo-img ms-0 ms-md-1">
              {{-- <img src="/img/kasirchu.png" width="130" alt=""> --}}KasirCuy
            </a>
            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  <img src="/img/kasira.png" alt="" width="35" height="35" class="rounded-circle">
                </a>
  ...
  <script src="/js/spike.min.js"></script>
